...
1) We will import US COVID cases and deaths from the Johns Hopkins data set on github. 
...
4) We are interested in identifying regional disparities, if any, in a) mortality rate and b) case mortality rate in the United States. 
